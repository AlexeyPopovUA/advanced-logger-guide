    ...
    <article className="page-content page-about">
        ...
        <div className="page-content">
            ...
            <ul>
                ...
                <li>It is able to group duplicated logs in certain time interval (for rapid fire of the same logs)
                </li>
                <li>It is not afraid of circular links in log objects</li>
                <li>It supports custom format for logs (custom serializer)</li>
                <li>It supports different remote logger endpoints (SumoLogic, Loggly and Elasticsearch). Who is the
                    next? ᕙ(ಠ.ಠ)ᕗ
                </li>
            </ul>
